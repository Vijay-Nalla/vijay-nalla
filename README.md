...
I thrive at the intersection of cutting-edge technology and real-world problem solving — from building AI-powered platforms for MSMEs to winning hackathons in collaboration with **Microsoft Azure**.
...
<table>
  ...
  <tr>
    ...
    <td>Anurag University, Hyderabad</td>
    <td><b>CGPA: 8.65</b> (till 5th Sem)</td>
  </tr>
  <tr>
    <td>Board of Intermediate Education</td>
    <td>Narayana Junior College, Annojguda</td>
    <td><b>96.6%</b></td>
  </tr>
  <tr>
    <td>Board of Secondary Education</td>
    <td>ZPHS Raghunathpur, Rajapet</td>
    <td><b>GPA: 10.0</b></td>
  </tr>
</table>
...
- 🏛️ Completed an **8-week AI internship** at the International Institute of Information Technology, Hyderabad
- 🤖 Focused on **Large Language Models (LLMs)** and **Retrieval-Augmented Generation (RAG)**
- 🐍 Developed AI-based modules and intelligent systems using **Python**
- 🧑‍🏫 Mentored peers and led technical discussions
...
An AI-powered **multi-agent platform** automating marketing and customer support for MSMEs.

| Metric | Result |
|--------|--------|
| ⚡ Query Handling Speed | **30% Faster** |
| 📈 User Engagement | **+15% Rise** |
| 🤖 Core Tech | NLP, LLMs, Analytics |
...
<div align="center">
  <img src="https://img.shields.io/badge/IEEE%20CS-Student%20Chapter-87CEEB?style=for-the-badge&logo=ieee&logoColor=white"/>
</div>

<br/>

A responsive, interactive website for the IEEE CS Student Chapter at Anurag University.

| Metric | Result |
|--------|--------|
| 🚀 Load Time | **40% Faster** |
| 📊 User Engagement | **+20% Higher** |
| 📄 Sections | Events, Team, Updates |
...
| ✅ **Selected** | Smart India Hackathon (SIH) 2025 |
| 🏅 **Top 5 Finalist** | INNOQUEST #1 *(Microsoft Azure & Reskill)* |
...
| 🎓 Member | Career Odyssey Club *(Placement Support)* |
